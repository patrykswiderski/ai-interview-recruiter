...
function How() {
  return (
    <section className="py-8 bg-white z-50 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 h-min-screen md:h-screen">
      ...
      <div className="mt-12 text-center">
        <a
          href="/sign-in"
          className="inline-block rounded bg-primary px-12 py-3 text-sm font-medium text-white transition hover:scale-105 focus:outline-none focus:ring focus:ring-yellow-400"
        >
          Get Started Today
        </a>
      </div>
